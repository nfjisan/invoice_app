...
const router = useRouter()
    ...
    const onSave = () =>{
        if(listCart.value.length >=1){
            ...
            formData.append('due_date',form.value.due_data)
            ...
            <div class="card__content--header">
                <div>
                    ...
                    <select name="" id="" class="input" v-model="customer_id">
                        ...
                        <option :value="customer.id" v-for="customer in allcustomers" :key="customer.id">{{ customer.firstname  }}
                        </option>
                    </select>
                </div>
                <div>
                    <p class="my-1">Date</p>
                    <input id="date" placeholder="dd-mm-yyyy" type="date" class="input" v-model="form.data"> <!---->
                    <p class="my-1">Due Date</p>
                    <input id="due_date" type="date" class="input" v-model="form.due_data">
                </div>
                <div>
